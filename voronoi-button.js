...
class VoronoiButton extends HTMLElement{
  ...
  constructor(){
    ...
    this.svg.addEventListener('mouseover', this.mouseovered);
    this.svg.addEventListener('mouseleave', this.mouseleft);
    this.svg.addEventListener('mousemove', this.mousemoved);
